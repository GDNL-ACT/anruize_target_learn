...
MODE="prompt_lastpool_lmhead"
POOLING_MODEL="last"
MAX_LENGTH=128
BATCH_SIZE=8

FILE_NAME="learn_target_pretrain"
PEFT_MODEL_PATH_FIRST_STEP="./$FILE_NAME/llama_last_1step_bid"
PEFT_MODEL_PATH="./$FILE_NAME/llama_last_2step_bid"
OUTPUT_PATH="./$FILE_NAME/llama_last_2step_bid"
